      ...
      <div className="w-full h-full bg-white flex justify-evenly flex-col sm:flex-row p-20">
        <div className="w-2/5 p-12 rounded-xl">
          <form onSubmit={handleSubmit}>
            ...
            <h2 className="font-medium text-3xl text-gray-800 mb-2">
              Create an account
            </h2>
            ...
            <div className="space-y-4 mb-6">
              ...
              <button
                type="submit"
                className="w-full h-[55px] bg-black hover:bg-gray-700 text-white py-2 px-4 rounded transition duration-300 ease-in-out"
              >
                Sign Up
              </button>
          ...
          <div className="mt-8 p-4 bg-gray-100 rounded-lg text-xs text-gray-800">
            Your well-being is our priority! Our team is here to assist you
            every step of the way. Let us be a part of your journey to a better,
