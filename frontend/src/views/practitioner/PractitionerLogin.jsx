...
import support from "/images/loginPractitioner.jpeg";
      ...
      <div className="w-full h-full bg-white flex justify-evenly flex-col sm:flex-row p-20">
        <div className="w-2/5 p-12 rounded-xl">
          <form onSubmit={handleLogin}>
            ...
            <div className="font-medium text-gray-800 text-3xl mb-2">
              Welcome back!
            </div>
            <div className="font-light text-gray-800 text-md mb-8">
